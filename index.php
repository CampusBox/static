  ...
  <div class="container-fluid">
            ...
            <p>
             ...
             <div id="cover-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <img src="img/poetry.jpg">

                        </div>
                        <div class="item active">
                            <img src="img/pottery.jpg">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <img src="img/home/contribute.jpg" class="img-responsive" alt="Image">
            </div>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Feel free to tell us about anything.</h3>
                </div>
            </div>  
            <div class="row">
                <div class="col-lg-12">
